  ...
  return (
    ...
    >
      ...
      <div className=" rounded-lg shadow-md mx-auto my-8 p-8 max-w-[90%]">
        <div>
          <h2 className="text-3xl mb-1">Newsletter</h2>
          <p className="mb-6 text-gray-600">
            ¡Suscríbete a nuestro boletín para recibir actualizaciones,
            noticias, consejos y promociones!
          </p>
          <div className="flex flex-wrap gap-2.5 md:flex-row">
            ...
            <input
              ...
              className="flex-1 min-w-[200px] p-2.5 border border-gray-300 rounded"
            />
            <Button className="text-gray-800 font-bold py-2.5 px-10 rounded">
              Regístrate
            </Button>
          </div>
        </div>
      ...
      <div className="flex flex-wrap justify-between p-8">
        <div className="flex-1 min-w-[250px] mr-8 mb-6">
          ...
          />
          <p>
            En Pawify creemos que cada mascota merece un hogar lleno de amor.
          </p>
          <div className="flex gap-4 mt-6">
            <a
              href="https://www.instagram.com/pawify.adoptdontshop/?hl=es"
      ...
      <div className="text-center ">
        <p className="text-sm text-gray-600">
          &copy; 2025 Pawify. Todos los derechos reservados.
        </p>
      </div>
    </footer>
  );
