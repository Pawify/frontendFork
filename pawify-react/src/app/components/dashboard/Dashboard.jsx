        ...
        <div className="max-w-[1440px] mx-auto grid grid-cols-1 md:grid-cols-5 md:grid-rows-6  p-2 pt-8 gap-4 w-full">
            ...
            <div className="bg-gray-200 rounded-2xl md:row-span-4 order-2 md:order-1">
                ...
                <ul className="space-y-2">
                        <li
                            style={{ backgroundColor: selector === 'Anuncios' ? secondary : '' }} // Cambiar fondo según el selector
                            className={`cursor-pointer p-2 transition duration-500 rounded hover:bg-[#98b0e5] ${selector === 'Anuncios' ? 'text-white' : ''}`}
                            onClick={() => setSelector('Anuncios')}
                        >
                            Anuncios
                        </li>
                        <li
                            style={{ backgroundColor: selector === 'Favoritos' ? secondary : '' }}
                            className={`cursor-pointer p-2 transition duration-500 rounded hover:bg-[#98b0e5] ${selector === 'Favoritos' ? 'text-white' : ''}`}
                        ...
                        <li
                            ...
                            className={`cursor-pointer p-2 transition duration-500 rounded hover:bg-[#98b0e5] ${selector === 'Chat' ? 'text-white' : ''}`}
                        ...
                        <li
                            ...
                            className={`cursor-pointer p-2 transition duration-500 rounded hover:bg-[#98b0e5] ${selector === 'Pagos' ? 'text-white' : ''}`}
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between bg-gray-200 rounded-2xl p-6 md:col-span-5 order-1 md:order-2">
                <img src={perfil} className="object-contain rounded-full h-12 w-12 mb-2 sm:mb-0 sm:mr-4" alt="Perfil" />
                <div className="text-center sm:text-left">
                    <p className="font-semibold">Juan</p>
                    <p><span className="font-medium">Email:</span> usuario@gmail.com</p>
                </div>
            </div>
